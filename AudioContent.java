...
abstract public class AudioContent
{
	...
	public AudioContent()//empty constructer initialization
	{
		this.title = "";
		this.year = 0;
		this.id = "";
	...
	public AudioContent(String title, int year, String id, String type, String audioFile, int length)//initializing constructer with variables
	{
		this.title = title;
		this.year = year;
		this.id = id;
  ...
  // Play the content through the audio file
	public void play()
	{
		this.printInfo();
	...
	//  If two audiobooks have the same title and id then they are equal
